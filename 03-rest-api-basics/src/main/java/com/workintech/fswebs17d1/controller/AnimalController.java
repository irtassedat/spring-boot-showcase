...
public class AnimalController {
    ...
    public void loadAll(){
        ...
        System.out.println("Loaded animals" + animals);
    ...
    public Animal getAnimal(@PathVariable("id") int id) {
        System.out.println("Getting animal by id: " + id);
    ...
    public Animal updateAnimal(@PathVariable("id") int id, @RequestBody Animal newAnimal) {
        System.out.println("Updating animal: " + newAnimal);
    ...
    public void deleteAnimal(@PathVariable("id") int id) {
        System.out.println("Deleting animal: " + id);
